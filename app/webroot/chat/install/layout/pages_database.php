			...
			?>
				...
				<table class="form-table2"> 
					<tr> 
						...
						<td class="col2"><span class="formwrap"><input disabled="disabled" type="text" class="database_input" name="server" value="127.0.0.1" /></span></td> 
