				...
				<div class="module_content">
					...
					<fieldset class="firstFieldset">
								...
								<ul>
									<li>
										<label for="chatroom_type_1">
											<input type="radio" name="add_chatroom_type" value="1" id="chatroom_type_1" /> Public
										</label>
									</li>
									<li>
						...
						<dl class="selectionBox">
							...
							<dd>
								<input type="text" id="add_chatroom_length" class="selectionText" name="add_chatroom_length" maxlength="10" value="<?php if (var_check('add_chatroom_length')) echo get_var('add_chatroom_length'); ?>" />
								<p class="explain">
