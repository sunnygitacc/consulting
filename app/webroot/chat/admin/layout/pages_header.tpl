...
<div id="wrapper">
	...
	<div id="content">
		<div id="leftcontent">
				{if empty($smarty.get.do) or $smarty.get.do eq 'chatfeatures' or $smarty.get.do eq 'chatsettings' or $smarty.get.do eq 'delete_history' or $smarty.get.do eq 'embedcodes'}
				<div class="admin_title_bg"> 
					<ul id ="menu-general"> 
						<li class="navHead">Home</li>
						<li {if empty($smarty.get.do) or $smarty.get.do eq 'delete_history'}class="active_nav"{/if}><a href="./">Overview</a></li> 
