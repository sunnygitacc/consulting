<?php 
	...
	*/
	...
	define('DB_USERNAME','destina1_wizspea'); 
	define('DB_PASSWORD','C]JZhzABGWch'); 
	define('DB_NAME','destina1_wiz');	
	...
	*/
	...
	define('DB_FRIENDSTABLE','user_friends'); 
	define('DB_FRIENDSTABLE_USERID', 'user_id_a'); 
	define('DB_FRIENDSTABLE_FRIENDID', 'user_id_b'); 
	define('DB_FRIENDSTABLE_FRIENDS', 'request_status');
