...
//        pr($ambition_subcategorys);
        ...
        <div class="createG-row">
            <div class="createG-row-label">Coach :</div>
            <div class="createG-row-value">
                
                <?php 
                echo $this->Form->input('ambitions_category',array('id'=>'select_coach','class'=>'form-input2 select_group_admin','label'=>false, 'required' =>true));
                echo $this->Form->input('select_coach_id',array('id'=>'select_coach_id','class'=>'form-input2','type'=>'hidden', 'required' =>true ));
                ?> 
        ...
        <div class="createG-row">
            <div class="createG-row-label">Captain :</div>
            <div class="createG-row-value">
                <?php 
                echo $this->Form->input('ambitions_subcategory',array('id'=>'select_captain','class'=>'form-input2 select_group_admin','label'=>false, 'required' =>true));
                echo $this->Form->input('select_captain_id',array('id'=>'select_captain_id','class'=>'form-input2','type'=>'hidden', 'required' =>true ));
                ?> 
