                            <div class="profile-row-mids" id="about_me_labels">
                                ...
                                <?php } ?>
                                <h3>About</h3>
                                <p><?php echo $profile_status; ?></p>

                                
                            </div>
                            <div class="profile-row-mids" id="about_me_edit" style="display:none;">
                                <textarea id="about_me_edit_text" name="about_me_edit" style="width:99%;font-family: inherit;" rows="4"><?php echo $profile_status; ?></textarea>
                                <div class="share">
                                    ...
                                    <?php foreach($educations as $education) { 
                                     ...
                                     ?>
                                    	...
                                    	<div class="edu-desc-row">
	                                    	<div class="edu-desc-row-inner">
                                            <?php if($p_edit){  ?>        
                                                <div class="editPencil pencil editDummy" id="<?php echo $education['UserEducation']['id']?>">&nbsp;</div>
                                            <?php } ?> 
                                                
	                                        <h4><?php echo $education['UserEducation']['education']?></h4>
	                                        <p><?php echo $education['UserEducation']['institute'].' ('.$education['UserEducation']['university'].' )'?></p>
	                                        <p><?php echo $year ?></p>
                                                </div>
                                    	</div>
