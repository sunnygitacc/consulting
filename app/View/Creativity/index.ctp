<div class="right-extended">
    ...
    <div class="flr-left-section">
        <div class="flr-search">
			...
			<?php echo $this->Form->create('creativity', array('url' => array('controller' => 'creativity', 'action' => 'search'), 'type' => 'get'));
                        ...
                        <div id="preview_postimage" >
                            <div class="meta-form"  >
                                ...
                                <div class="createG-row">
                                    ...
                                    'class'=>'form-input',
                                    'class'=>'form-input',
										'options' => array(1 => 'Music', 2 => 'Movies', 3 => 'Sports', 4 => 'Nature', 5 => 'Science', 6 => 'Comedy', 7 => 'Tutorials', 8 => 'Animation'),
                                    'empty' => 'Select',
                                    'required'=>true
                                     ));
                                ?>
                                ...
                                <div class="createG-row">
                                        <div class="createG-row-label">Tag (seperated by Comma):</div>
									<div class="createG-row-value">
										<?php echo $this->Form->input('tags', array('id' => 'tags', 'class' => 'common-input1', 'type' => 'text', 'label' => false)); ?>
									</div>
                                </div>
...
?>
    ...
    <div class="filter-contents">
        <div id="filter-videos" class="filter-con-row">
            ...
            <div class="filter-con-row-inner">
                ...
                <div class="filter-box">
					...
					<div class="details-edit"><a
							href="<?php echo 'http://localhost/wizspeak/creativity/edit/' . $vid->id ?>"> <b>Edit </b>
						</a></div>
                                    </div>
			</div>
                 <?php                }  ?>
        ...
        <div id="filter-images" class="filter-con-row">
            ...
            <div class="filter-con-row-inner">
				<?php foreach ($Creativity_img as $key => $image) {
                ...
                <div class="filter-box">
                    ...
                    <div class="filter-box-details">
						...
						<div class="details-thumb">Uploaded by
							<b><?php echo $image->postby_name ; ?></b>

						</div>
						<div class="details-edit"><a
								href="<?php echo 'http://localhost/wizspeak/creativity/edit/' . $image->id; ?>">
								<b>Edit </b>
							</a></div>
                    </div>
                </div>
        ...
        <div id="filter-documents" class="filter-con-row">
            ...
            <div class="filter-con-row-inner">
				<?php foreach ($Creativity_doc as $key => $doc) {
...
// echo $this->Html->image('icon_03.jpg'); ?>
                    ...
                    <div class="filter-box-details">
						...
						<div class="details-thumb">Uploaded By
							<b><?php echo $doc->postby_name ; ?></b>

						</div>
						<div class="details-edit"><a
								href="<?php echo 'http://localhost/wizspeak/creativity/edit/' . $doc->id ?>">
								<b>Edit </b> </a></div>
                    </div>
                </div>
                <?php                }  ?>
            ...
            <div class="filter-con-row-inner">
				<?php foreach ($Creativity_aud as $key => $aud) {
                    ...
                    <div class="filter-box-details">
						...
						<div class="details-edit"><a
								href="<?php echo 'http://localhost/wizspeak/creativity/edit/' . $aud->id ?>">
								<b>Edit </b> </a></div>
                    </div>
                </div>
