    ...
    <div class="filter-contents">
        <div id="filter-videos" class="filter-con-row">
            ...
            <div class="filter-con-row-inner">
                 <?php foreach ($Creativity_sv as $key => $vid) {
        ...
        <div id="filter-images" class="filter-con-row">
            ...
            <div class="filter-con-row-inner">
                <?php foreach ($Creativity_si as $key => $image) {
    // pr($Creativity_img);
                    ?>
                <div class="filter-box">
        ...
        <div id="filter-documents" class="filter-con-row">
            ...
            <div class="filter-con-row-inner">
                <?php foreach ($Creativity_sd as $key => $doc)  {
...
// echo $this->Html->image('icon_03.jpg'); ?>
        ...
        <div id="filter-audios" class="filter-con-row">
            ...
            <div class="filter-con-row-inner">
                 <?php foreach ($Creativity_sa as $key => $aud) {
                ...
                <div class="filter-box">
                    ...
                    <div class="filter-box-details">
                        <h3><?php echo $aud['Post']['title'];?></h3></a>
                        <div class="details-thumb">Uploaded by <b><?php echo $aud['Postby']['first_name'].' '. $image['Postby']['last_name']; ?></b>
                        </div>
                    </div>
                </div>
