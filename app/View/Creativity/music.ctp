<div class="right-extended">
			...
			<div id="preview_postimage">
				<div class="meta-form">
					...
					<div class="createG-row">
						...
						<div class="createG-row-value">
							...
							echo $this->Form->input('category', array(
								...
								'class' => 'form-input',
								'class' => 'form-input',
								'options' => array(2 => 'Movies', 1 => 'Music', 3 => 'Sports', 4 => 'Nature', 5 => 'Science', 6 => 'Comedy', 7 => 'Tutorials', 8 => 'Animation'),
								'empty' => 'Select',
								'required' => true
							));
							?>
					...
					<div class="createG-row">
						...
						<div class="createG-row-value">
							<input type="text" value="" id='tags' class="form-input1"/>
							<button type="button" style='visibility: hidden;' id="add_button_creativity">Add</button>
						</div>
					</div>
	...
	<div class="filter-contents">
		<div id="filter-videos" class="filter-con-row">
			...
			<div class="filter-con-row-inner">
				<?php foreach ($Creativity_mv as $key => $vid) {
	...
	<div id="filter-images" class="filter-con-row">
		...
		<div class="filter-con-row-inner">
			<?php foreach ($Creativity_mi as $key => $image) {
	...
	<div id="filter-documents" class="filter-con-row">
		...
		<div class="filter-con-row-inner">
			<?php foreach ($Creativity_md as $key => $doc) {
	...
	<div id="filter-audios" class="filter-con-row">
		...
		<div class="filter-con-row-inner">
			<?php foreach ($Creativity_ma as $key => $aud) {
