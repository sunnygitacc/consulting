<div class="mid-section">
    ...
    <div class="post-users-video">
      <video id="example_video_<?php echo $player['Post']['id']; ?>"  poster='<?php echo 'http://gopuonline.com/tec1/'.CRE_VIDEO_THUMBNAIL_UPLOAD_FOLDER.$player['Post']['link'].'_196x110_thumb.png'; ?>' width="100%" height="100%" controls preload="auto" data-setup="{}" controls autoplay>
        <source src="<?php echo 'http://gopuonline.com/tec1/'.CRE_VIDEO_UPLOAD_FOLDER.$player['Post']['link'].'_720x576_video.mp4' ?>" type='video/mp4' />
                        ...
                        <div class="entrment-video-details">
                            <h3><?php echo $player['Post']['title'];?></h3>
                            <div class="entrment-video-details2">
                                <div class="entrment-videod-left">
                                    
                                    <span>Uploaded by <b><?php echo $player['Postby']['first_name'].' '. $player['Postby']['last_name']; ?></b></span>
                                </div>
 ...
 <?php foreach ($Creativity_vid as $key => $vid) { 
                    ...
                    ?>
                                <div  class="filter-box">
                                      <a href="<?php echo 'http://gopuonline.com/tec1/creativity/player/'.$vid['Post']['id'] ?>"> 
