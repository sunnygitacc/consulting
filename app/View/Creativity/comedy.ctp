    ...
    <div class="filter-contents">
        <div id="filter-videos" class="filter-con-row">
            ...
            <div class="filter-con-row-inner">
                 <?php foreach ($Creativity_cv as $key => $vid) {

                    ?>

                <div class="filter-box">54
                    <a href="<?php echo 'http://localhost/wizspeak/creativity/player/'.$vid['Post']['id'] ?>">
                        <div data-rel="sharepopup-video"  class="filter-box-thumb video_view_popupp">
                                        <span class="icon-video">&#xf01d</span>
                                         <span   title="<?php  echo  $vid['Post']['title']; ?>"</span>

                              <?php echo $this->Html->image('/'.CRE_VIDEO_THUMBNAIL_UPLOAD_FOLDER.$vid['Post']['link'].'_196x110_thumb.png');
                           ?>

                                    </div>

                                    <div class="filter-box-details">
                                         <h3><?php echo $vid['Post']['title'];?></h3></a>
        ...
        <div id="filter-images" class="filter-con-row">
            ...
            <div class="filter-con-row-inner">
                <?php foreach ($Creativity_ci as $key => $image) {
    // pr($Creativity_img);
                    ?>
                <div class="filter-box">
                    <div class="filter-box-thumb">
                             ...
                             <a title="<?php  echo  $image['Post']['title']; ?>"

                                href="<?php echo 'http://localhost/wizspeak/'.CRE_IMAGE_UPLOAD_FOLDER.$image['Post']['link'];  ?>" rel="lightbox" >
                              <?php echo $this->Html->image('/'.CRE_IMAGE_UPLOAD_FOLDER.$image['Post']['link']);
                           ?>  </a>

                    </div>
                    <div class="filter-box-details">
                        <h3><?php echo $image['Post']['title'];?></h3>
                        <div class="details-thumb">Uploaded by <b><?php echo $image['Postby']['first_name'].' '. $image['Postby']['last_name']; ?></b>
        ...
        <div id="filter-documents" class="filter-con-row">
            ...
            <div class="filter-con-row-inner">
                <?php foreach ($Creativity_cd as $key => $doc)  {
                ...
                <div class="filter-box">
                    <div class="filter-box-thumb">
                        ...
                        <span class="icon-doc">
                            <?php
                            echo $this->Html->image('down.png', array('url' =>'/'.CRE_DOC_FOLDER.$doc['Post']['link']));
// echo $this->Html->image('icon_03.jpg'); ?>
                        </span>
                    </div>
                    <div class="filter-box-details">
                        <h3><?php echo $doc['Post']['title'];?></h3>
                        <div class="details-thumb">Uploaded By <b><?php echo $doc['Postby']['first_name'].' '. $image['Postby']['last_name']; ?></b>
                        </div>
                    </div>
                </div>
                <?php                }  ?>
        ...
        <div id="filter-audios" class="filter-con-row">
            ...
            <div class="filter-con-row-inner">
                 <?php foreach ($Creativity_ca as $key => $aud) {

                    ?>

                <div class="filter-box">
                    <a href="<?php echo 'http://localhost/wizspeak/creativity/audio/'.$aud['Post']['id'] ?>">
                    <div class="filter-box-thumb">
                    ...
                    <div class="filter-box-details">
                        <h3><?php echo $muaud['Post']['title'];?></h3></a>
                        <div class="details-thumb">Uploaded by <b><?php echo $muaud['Postby']['first_name'].' '. $image['Postby']['last_name']; ?></b>
                        </div>
                    </div>
                </div>
