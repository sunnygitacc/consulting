    ...
    <div class="filter-contents">
        <div id="filter-videos" class="filter-con-row">
            ...
            <div class="filter-con-row-inner">
                 <?php foreach ($Creativity_nv as $key => $vid) {
        ...
        <div id="filter-images" class="filter-con-row">
            ...
            <div class="filter-con-row-inner">
                <?php foreach ($Creativity_ni as $key => $image) {
    // pr($Creativity_img);
                    ?>
                <div class="filter-box">
        ...
        <div id="filter-documents" class="filter-con-row">
            ...
            <div class="filter-con-row-inner">
                <?php foreach ($Creativity_nd as $key => $doc)  {
...
// echo $this->Html->image('icon_03.jpg'); ?>
        ...
        <div id="filter-audios" class="filter-con-row">
            ...
            <div class="filter-con-row-inner">
                 <?php foreach ($Creativity_na as $key => $muaud) {

                    ?>

                <div class="filter-box">
                    <a href="<?php echo 'http://gopuonline.com/tec1/creativity/audio/'.$muaud['Post']['id'] ?>">
                    <div class="filter-box-thumb">
                    ...
                    <div class="filter-box-details">
                        ...
                        <div class="details-thumb">Uploaded by <b><?php echo $muaud['Postby']['first_name'].' '. $muaud['Postby']['last_name']; ?></b>
                        </div>
                    </div>
                </div>
