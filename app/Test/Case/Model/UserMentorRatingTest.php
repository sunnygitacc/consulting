<?php
App::uses('UserMentorRating', 'Model');

/**
 * UserMentorRating Test Case
 *
 */
class UserMentorRatingTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->UserMentorRating = ClassRegistry::init('UserMentorRating');
	}
