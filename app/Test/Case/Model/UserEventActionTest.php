<?php
App::uses('UserEventAction', 'Model');

/**
 * UserEventAction Test Case
 *
 */
class UserEventActionTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->UserEventAction = ClassRegistry::init('UserEventAction');
	}
