<?php
App::uses('UserPostView', 'Model');

/**
 * UserPostView Test Case
 *
 */
class UserPostViewTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->UserPostView = ClassRegistry::init('UserPostView');
	}
