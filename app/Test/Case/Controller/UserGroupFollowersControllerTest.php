<?php
App::uses('UserGroupFollowersController', 'Controller');

/**
 * UserGroupFollowersController Test Case
 *
 */
class UserGroupFollowersControllerTest extends ControllerTestCase {
