<?php
App::uses('UserGroupProfilePicsController', 'Controller');

/**
 * UserGroupProfilePicsController Test Case
 *
 */
class UserGroupProfilePicsControllerTest extends ControllerTestCase {
