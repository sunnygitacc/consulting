<?php
App::uses('RolePermissionRelationsController', 'Controller');

/**
 * RolePermissionRelationsController Test Case
 *
 */
class RolePermissionRelationsControllerTest extends ControllerTestCase {
