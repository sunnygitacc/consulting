<?php
App::uses('UserCertificationsController', 'Controller');

/**
 * UserCertificationsController Test Case
 *
 */
class UserCertificationsControllerTest extends ControllerTestCase {
