<?php
App::uses('UserGroupRelationsController', 'Controller');

/**
 * UserGroupRelationsController Test Case
 *
 */
class UserGroupRelationsControllerTest extends ControllerTestCase {
