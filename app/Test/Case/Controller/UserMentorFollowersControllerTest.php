<?php
App::uses('UserMentorFollowersController', 'Controller');

/**
 * UserMentorFollowersController Test Case
 *
 */
class UserMentorFollowersControllerTest extends ControllerTestCase {
