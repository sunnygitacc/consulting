 ...
 * @property UserEventAction $UserEventAction
 ...
 */
        	...
        	public $hasOne = array(
		'UserGroupProfilePic' => array(
			'className' => 'UserGroupProfilePic',
			'foreignKey' => 'wall_id',
			'dependent' => false,
			'conditions' => array('UserGroupProfilePic.wall_type' => 1, 'UserGroupProfilePic.is_avatar' => 1,'UserGroupProfilePic.is_active' => 1),
			'fields' => '',
			'order' => '',
			'limit' => '',
			'offset' => '',
	...
	public $hasMany = array(
		...
		'UserEventAction' => array(
			'className' => 'UserEventAction',
			'foreignKey' => 'user_id',
			'dependent' => false,
			'conditions' => '',
			'fields' => '',
		...
		'UserGroupFollower' => array(
			'className' => 'UserGroupFollower',
			'foreignKey' => 'user_id',
			'dependent' => false,
			'conditions' => '',
			'fields' => '',
		...
		'UserMentorFollower' => array(
			'className' => 'UserMentorFollower',
			'foreignKey' => 'user_id',
			'dependent' => false,
			'conditions' => '',
			'fields' => '',
		...
		'UserMentorRating' => array(
			'className' => 'UserMentorRating',
			'foreignKey' => 'user_id',
			'dependent' => false,
			'conditions' => '',
			'fields' => '',
		...
		'UserReportAbus' => array(
			'className' => 'UserReportAbus',
			'foreignKey' => 'user_id',
			'dependent' => false,
			'conditions' => '',
			'fields' => '',
